...
class TestCompareSnapshots:
    ...
    def test_no_previous_snapshot(self, tmp_path: Any) -> None:
    ...
    def test_identical_data_returns_empty(self, tmp_path: Any) -> None:
    ...
    def test_detects_status_change(self, tmp_path: Any) -> None:
    ...
    def test_detects_new_field(self, tmp_path: Any) -> None:
        """Should detect when a new field is added."""
        old_data = {"protocolSection": {"statusModule": {"overallStatus": "ACTIVE"}}}
        new_data = {
            "protocolSection": {
                "statusModule": {"overallStatus": "ACTIVE", "newField": "value"}
            }
        }
    ...
    def test_corrupted_previous_snapshot_returns_none(self, tmp_path: Any) -> None:
    ...
    def test_empty_previous_snapshot_returns_none(self, tmp_path: Any) -> None:
    ...
    def test_truncated_json_snapshot_returns_none(self, tmp_path: Any) -> None:
        """Truncated JSON (from interrupted write) should return None."""
        snapshot_path = tmp_path / "NCT_TRUNC_latest.json"
        snapshot_path.write_text(
            '{"protocolSection": {"statusModule":', encoding="utf-8"
        )
    ...
    def test_missing_protocol_section(self, tmp_path: Any) -> None:
...
class TestFormatDiff:
    ...
    def test_fallback_diff_format(self) -> None:
        """Fallback diff (simple dict) should produce readable output."""
        diff = {"Status": {"old": "RECRUITING", "new": "COMPLETED"}}
    ...
    def test_deepdiff_values_changed(self) -> None:
    ...
    def test_deepdiff_item_added(self) -> None:

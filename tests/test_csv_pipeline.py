...
SAMPLE_RAW_TRIAL_2 = {
    "protocolSection": {
        ...
        "sponsorCollaboratorsModule": {"leadSponsor": {"name": "BioGen Labs"}},
        "designModule": {"enrollmentInfo": {"count": 250}, "phases": ["PHASE3"]},
...
class TestFlattenDictColumnNames:
    ...
    def test_status_column_name(self) -> None:
    ...
    def test_phases_column_name(self) -> None:
        flat = flatten_dict(SAMPLE_RAW_TRIAL)
    ...
    def test_sponsor_column_name(self) -> None:
        flat = flatten_dict(SAMPLE_RAW_TRIAL)
    ...
    def test_all_qmd_expected_columns_present(self) -> None:
...
class TestSaveTargetDataCSV:
    ...
    def test_csv_files_created(self, tmp_path: Any, monkeypatch: Any) -> None:
    ...
    def test_csv_readable_by_pandas(self, tmp_path: Any, monkeypatch: Any) -> None:
        ...
        csv_path = str(
            tmp_path / "data" / "targets" / "testtarget" / "all_trials_raw.csv"
        )
    ...
    def test_csv_contains_qmd_columns(self, tmp_path: Any, monkeypatch: Any) -> None:
    ...
    def test_csv_status_values_correct(self, tmp_path: Any, monkeypatch: Any) -> None:
    ...
    def test_csv_sponsor_values_correct(self, tmp_path: Any, monkeypatch: Any) -> None:
    ...
    def test_empty_raw_data_no_csv(self, tmp_path: Any, monkeypatch: Any) -> None:

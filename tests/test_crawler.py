...
class TestSaveSnapshot:
    ...
    def test_creates_snapshot_file(self, tmp_path: Any) -> None:
    ...
    def test_overwrites_existing_snapshot(self, tmp_path: Any) -> None:
        old_data = {"version": 1}
        new_data = {"version": 2}
...
class TestFetchTrialData:
    ...
    @patch("crawler.get_session")
    def test_404_returns_none(self, mock_get_session: MagicMock) -> None:
    ...
    @patch("crawler.get_session")
    def test_server_error_returns_none(self, mock_get_session: MagicMock) -> None:
    ...
    @patch("crawler.get_session")
    def test_network_exception_returns_none(self, mock_get_session: MagicMock) -> None:

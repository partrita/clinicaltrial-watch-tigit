...
class TestSafeJsonLoad:
    ...
    def test_missing_file_returns_none_default(self) -> None:
        result = safe_json_load("/nonexistent/path/file.json", default=None)
        assert result is None

    def test_default_is_empty_list_when_not_specified(self) -> None:
    ...
    def test_valid_json_dict(self, tmp_path: Any) -> None:
...
class TestUpdateHistory:
    ...
    def test_creates_new_history_file(self, tmp_path: Any) -> None:
        """Should create a new history file for a new trial."""
        history_dir = str(tmp_path / "history")
        update_history(
            "NCT00000001", "Initial data collection", history_dir=history_dir
        )
    ...
    def test_appends_to_existing_history(self, tmp_path: Any) -> None:
...
class TestUpdateTargetHistory:
    ...
    def test_creates_initial_target_history(self, tmp_path: Any) -> None:
    ...
    def test_records_changed_trials(self, tmp_path: Any) -> None:
    ...
    def test_no_update_when_no_changes(self, tmp_path: Any) -> None:
...
class TestFlattenDict:
    ...
    def test_protocol_section_shortening(self) -> None:
...
class TestSaveTargetData:
    ...
    def test_saves_json_and_csv(self, tmp_path: Any, monkeypatch: Any) -> None:
    ...
    def test_saves_empty_report(self, tmp_path: Any, monkeypatch: Any) -> None:

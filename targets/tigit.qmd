...
if os.path.exists(summary_path):
    ...
    print("| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |")
    from src.utils import get_status_badge, get_update_badge, escape_html
    for item in summary:
